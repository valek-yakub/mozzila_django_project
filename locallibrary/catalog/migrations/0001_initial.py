...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(blank=True, choices=[('En', 'English'), ('Ru', 'Russian'), ('Ge', 'German'), ('Fr', 'French'), ('It', 'Italian')], default='En', help_text="Enter the book's natural language (e.g. English, French, German etc.)", max_length=20)),
            ],
        ),
        migrations.CreateModel(
            name='BookInstance',
